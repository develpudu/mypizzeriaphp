...
-- Volcando datos para la tabla pizza.c_orders: 2 rows
/*!40000 ALTER TABLE `c_orders` DISABLE KEYS */;
INSERT INTO `c_orders` (`id`, `refid_user`, `refid_menu`, `quantity`, `table_number`, `edits`, `timestamp`) VALUES
	(7, 0, 15, 1, 3, 'algo', '2021-04-05 06:06:58'),
	(8, 0, 1, 6, 10, '', '2021-04-05 07:41:09');
...
-- Volcando datos para la tabla pizza.menu: 45 rows
...
-- Volcando datos para la tabla pizza.orders: 1 rows
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT INTO `orders` (`id`, `refid_user`, `refid_menu`, `quantity`, `table_number`, `edits`, `timestamp`) VALUES
	(9, 0, 1, 1, 1, '', '2021-04-05 07:44:13');
...
-- Volcando datos para la tabla pizza.users: 3 rows
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `surname`, `username`, `psw`, `photo_url`, `level`, `registered`) VALUES
	(1, 'devel', 'pudu', 'develpudu', '200820e3227815ed1756a6b531e7e0d2', '', 0, '2021-04-05 05:14:31'),
	(2, 'once u created another account', 'delete me', 'user1', '200820e3227815ed1756a6b531e7e0d2', '', 1, '2021-04-05 05:14:31'),
	(3, 'once u created another account', 'delete me', 'user2', '200820e3227815ed1756a6b531e7e0d2', '', 2, '2021-04-05 05:14:31');
