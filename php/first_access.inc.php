...
error_reporting(E_ALL);
    ...
    if ($result) {
        $messages[] = "La base de datos ha sido creada con éxito.";
    } else {
    ...
    // if ($restables) {
    //     $messages[] = "La tablas han sido creadas con éxito.";
    // } else {
    //     $errors[] = "Error description: " . $conn->error;
    // }
    ...
    if ($resultacc) {
        $messages[] = "Usuario admin ha sido creada con éxito.";
    } else {
        $errors[] = "Error description: " . $conn->error;
    }
    ...
    if ($_POST['querycheck']==true) {
        ...
        if ($resultquery) {
            $messages[] = "Tabla eventos ha sido creada con éxito.";
        } else {
            $errors[] = "Error description: " . $conn->error;
        }        
    }
