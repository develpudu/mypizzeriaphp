...
<head>
    ...
    <script>
        function pop_up(url) {
            window.open(url, 'win2', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=no,width=680,height=670,directories=no,location=no')
        }
    </script>
</head>
                ...
                "
                        ...
                        <div class='card-body row'>
                            <div class='col-sm-6'>
                                ...
                                <span style='margin-top: -0.3em;' class='badge badge-pill align-middle badge-";
                echo $theme;
                echo "'>";
                if ($row["orders"] == 1) {
                    ...
                    while ($roword = $resultord->fetch_assoc()) {
                        ...
                        echo "<div class='col text-right'>
                                        ...
                                        <div class='custom-control custom-checkbox'>
                                            ...
                                            <label class='custom-control-label' for='" . $roword['id'] . "'>" . ($arraylang[$lang]['ready']) .
                        "</label>
                                        </div>
            ...
            echo '<div class="jumbotron jumbotron-fluid" style="margin-top: 2rem; max-width: 50%; background-color: transparent !important;">
                    <div class="container">
                        ...
                        <div class="animated fadeInUp delay-1s">
                            ...
                            <h5 class="text-muted">' . $arraylang[$lang]['dbemptytext'] . '&nbsp;<a class="text-' . $theme . '" href="" onclick="pop_up(\'../serve/\');">' . $arraylang[$lang]['dbemptylink'] . '</a></h5>
                        </div>
                    </div>
                  </div>';
        }
