...
<script src="/resources/bootstrap-select.js"></script>
<link rel="stylesheet" href="/resources/bootstrap-select.css">
<html>
                            ...
                            <div class="form-group">
                                <label for="name"><b><?php echo ($arraylang[$lang]['food']); ?>:</b><br>
                                    <div class="input-group" style="flex-wrap: nowrap;">
                                        <select class="form-control form-control-lg selectpicker" style="width: 15rem;" id="name" name="name" data-live-search="true" required>
                                            <?php
                                            $sql = 'SELECT menu.id,menu.name,m_tipo.tipo FROM menu INNER JOIN m_tipo ON menu.tipo = m_tipo.id ORDER BY m_tipo.tipo, menu.name ASC';
